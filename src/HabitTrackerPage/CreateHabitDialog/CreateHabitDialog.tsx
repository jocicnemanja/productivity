...
import { createHabit } from '../HabitTrackerService'
...
export const CreateHabitDialog = (props: CreateHabitDialogProps) => {
              ...
              <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                ...
                {isSaving() ?
                  ...
                  : <button type="button"
                    ...
                    onClick={save}
                  >
                    {props.habit && props.habit.id ? 'Update habit' : 'Create habit'}
                  </button>
                }
                <button
                  onClick={close}
