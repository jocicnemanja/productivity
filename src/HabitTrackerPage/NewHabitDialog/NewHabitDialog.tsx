          ...
          <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all md:max-w-5xl md:w-full m-3 md:mx-auto">
                      ...
                      <form>
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                          <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                              <input
                               oninput={(e) => setHabit({ ...habit(), description: e.target.value })}
              ...
              <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                ...
                {isSaving() ?
                  <button disabled={true} type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
                  ...
                  : <button type="button"
                    ...
                    onClick={save}
                  >
                    {props.habit && props.habit.id ? 'Edit habit' : 'Create new habit'}
                  </button>
                }
                <button
                  onClick={close}
